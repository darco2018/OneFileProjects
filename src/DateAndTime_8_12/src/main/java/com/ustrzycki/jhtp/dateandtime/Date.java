...
public void nextDay()
{
	   if (month == 2 && day == 28 && Year.isLeap(year))//check for 29th February
	   {
		   day = 29;		   
	   }
	   else
	   {
		   if (day == 31 && month == 12) //check for 31st December
		   {
			   day = 1;
			   month = 1;
			   year += 1;
		   ...
		   {
			   if(day + 1 > daysPerMonth[month]) // check for last day of a month
			   {
				   day = 1;
				   month += 1;
			   }
