...
public class TicTacToeConsole
{
	...
	/**
	 * Runs one complete TicTacToe game until it's won or drawn
	 */
	...
	{				
		...
		{				
			...
			engine.setXorOinSquare(numberOfSquareToMark); 				
	...
	{		
		System.out.printf("%n%s%n", engine.getWinningMessage());
	}
	...
	{		
		System.out.printf("%n%s", engine.getWhoseMoveMessage());
	}
